...
const domisticCoursesSlice = createSlice({
  name: 'domisticCourses',
  initialState: {
    courses: [], // corrected from domesticCourses
    selectedCourse: {}, // corrected from selectedDomesticCourse
    courseCount: 0, // corrected from domsticCourseCount
    loading: false,
    error: null,
  },
  reducers: {
...
export const {
  ...
  deleteCourseSuccess,
  deleteCourseFail,
} = domisticCoursesSlice.actions;

export default domisticCoursesSlice.reducer;
