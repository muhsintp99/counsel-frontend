      ...
      <Box sx={viewDrawerStyles.mainBox}>
        <Box sx={viewDrawerStyles.head}>
          ...
          <Grid sx={viewDrawerStyles.headContent}>
            <Typography sx={viewDrawerStyles.drawerTitle}>State Details</Typography>
          </Grid>
        </Box>
          ...
          <Grid container sx={viewDrawerStyles.dataContainer} mt={2}>
            <Grid item xs={12} md={6}>
              <Box mb={2} sx={viewDrawerStyles.dataItem}>
                ...
                <Box>
                  <Typography sx={viewDrawerStyles.label}><strong>State Name</strong></Typography>
                  <Typography sx={viewDrawerStyles.value}>{capitalize(safeData.name)}</Typography>
                </Box>
              </Box>
              ...
              <Box mb={2} sx={viewDrawerStyles.dataItem}>
                ...
                <Box>
                  ...
                  <Typography sx={viewDrawerStyles.value}>{capitalize(safeData.country?.name) || 'N/A'}</Typography>
                </Box>
              </Box>
              ...
              <Box mb={2} sx={viewDrawerStyles.dataItem}>
                <ArrowRightIcon fontSize="small" />
                <Box>
                  <Typography sx={viewDrawerStyles.label}><strong>State Code</strong></Typography>
                  <Typography sx={viewDrawerStyles.value}>{safeData.code || 'N/A'}</Typography>
                </Box>
              </Box>
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Box mb={2} sx={viewDrawerStyles.dataItem}>
                ...
                <Box>
                  ...
                  <Typography sx={viewDrawerStyles.value}>{safeData.isActive ? 'Active' : 'Inactive'}</Typography>
                </Box>
              </Box>
              ...
              <Box mb={2} sx={viewDrawerStyles.dataItem}>
                ...
                <Box>
                  ...
                  <Typography sx={viewDrawerStyles.value}>
                    {safeData.createdAt ? format(new Date(safeData.createdAt), 'MM/dd/yyyy') : 'N/A'}
                  </Typography>
                </Box>
              </Box>
            </Grid>
